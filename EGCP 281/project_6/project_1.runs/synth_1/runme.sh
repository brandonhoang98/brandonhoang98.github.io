...
HD_PWD='D:/project_6/project_6/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SinDigWatch.vds -m64 -mode batch -messageDb vivado.pb -notrace -source SinDigWatch.tcl
