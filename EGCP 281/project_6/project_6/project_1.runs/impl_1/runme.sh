...
HD_PWD='D:/project_6/project_6/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SinDigWatch.vdi -applog -m64 -messageDb vivado.pb -mode batch -source SinDigWatch.tcl -notrace
